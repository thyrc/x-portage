...
SRC_URI="mirror://ubuntu/pool/universe/m/mediatomb/mediatomb_0.12.1-47-g7ab7616.orig.tar.xz -> mediatomb_0.12.1-47.tar.xz
	mirror://ubuntu/pool/universe/m/mediatomb/mediatomb_0.12.1-47-g7ab7616-1ubuntu2.debian.tar.xz -> mediatomb_0.12.1-47.debian.tar.xz"
...
src_prepare() {
	...
	eapply "${FILESDIR}"/${P}-time-t.patch
	eapply "${FILESDIR}"/${P}-threadpool.patch
	eapply "${FILESDIR}"/${P}-fix_includes.patch
